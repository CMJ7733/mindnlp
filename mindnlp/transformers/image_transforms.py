...
from mindnlp.utils import ExplicitEnum, TensorType, is_mindspore_tensor
...
def center_to_corners_format(bboxes_center: TensorType) -> TensorType:
    ...
    if is_mindspore_tensor(bboxes_center):
        return _center_to_corners_format(bboxes_center)
...
def corners_to_center_format(bboxes_corners: TensorType) -> TensorType:
    ...
    if is_mindspore_tensor(bboxes_corners):
        return _corners_to_center_format(bboxes_corners)
