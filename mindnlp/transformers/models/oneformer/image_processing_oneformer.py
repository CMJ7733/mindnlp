...
class OneFormerImageProcessor(BaseImageProcessor):
    ...
    def encode_inputs(
        ...
        if annotations is not None:
            ...
            for i, label in enumerate(annotations):
                ...
                mask_labels.append(Tensor.from_numpy(masks))
                class_labels.append(Tensor.from_numpy(classes).long())
    ...
    def post_process_instance_segmentation(
        ...
        results: List[Dict[str, mindspore.Tensor]] = []
        ...
        for i in range(batch_size):
            ...
            if task_type == "panoptic":
                keep = ops.zeros_like(scores_per_image).bool()
