...
class GPTTokenizerFast(PreTrainedTokenizerFast):
    ...
    def __init__(self, vocab_file=None, merges_file=None, tokenizer_file=None, unk_token="<unk>", **kwargs):
        ...
        Returns:
            None. This method initializes a GPTTokenizerFast object.
    ...
    def do_lower_case(self):
        ...
        Args:
            self: This parameter refers to the instance of the class itself. It is required for accessing the object's attributes and methods.
            
        Returns:
            None. This method always returns a boolean value of True indicating that lowercasing is enabled.
    ...
    def save_vocabulary(self, save_directory: str, filename_prefix: Optional[str] = None) -> Tuple[str]:
        ...
        Args:
            ...
            filename_prefix (Optional[str]): An optional prefix to be added to the filenames of the vocabulary files. Default is None.
        ...
        This method saves the vocabulary files generated by the GPTTokenizerFast instance to the specified directory. The save_directory parameter should be a valid directory path. If filename_prefix is
provided, it will be added as a prefix to the filenames of the vocabulary files. The method returns a tuple containing the filenames of the saved vocabulary files.
        """
